...
nutrition_file="/content/drive/MyDrive/capstone/nutritionperserving0_18.csv"
data = pd.read_csv(nutrition_file)
names=data.ingr

model = tf.keras.models.load_model("/content/drive/MyDrive/capstone/checkpoint_all/model_prep_rms_new.h5")
...
def classify_image(url):
  ...
  class_dict={'name': names[classes], 'total_cal': serving*calorie, 'total_fat': serving*fat, 'total_carb' : serving*carb, 'total_protein' : serving*protein, 'description' : desc}
  return class_dict
